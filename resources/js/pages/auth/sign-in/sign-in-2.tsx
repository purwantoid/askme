...
export default function SignIn2({ status, canResetPassword }: { status?: string; canResetPassword: boolean }) {
    return (
        <>
            <Head title="Login" />
                    ...
                    <div className="mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[350px]">
                        <div className="flex flex-col space-y-2 text-left">
                            ...
                            <p className="text-sm text-muted-foreground">
                                ...
                                <Link className="underline underline-offset-4 hover:text-primary" href={route('register')}>
                                    Register
                                </Link>
                            </p>
                        </div>
