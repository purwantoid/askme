...
export const asOptional = <T>(schema: z.ZodType<T>) => schema.optional().or(_emptyStringToUndefined);

export const zodErrorMap: z.ZodErrorMap = (issue: z.ZodIssueOptionalMessage, ctx: z.ErrorMapCtx) => {
